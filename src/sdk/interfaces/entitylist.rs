...
type GetEntityFromHandleFn = unsafe extern "thiscall" fn(thisptr: *mut usize, unknown: *mut usize) -> *mut usize;
...
impl CEntityList {
    ...
    pub fn get_client_entity_from_handle(&self, handle: *mut usize) -> *mut usize {
        unsafe {
